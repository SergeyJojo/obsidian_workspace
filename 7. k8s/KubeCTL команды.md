...
| Команда        | Что делает                       |
| -------------- | -------------------------------- |
| `get`          | Получить список ресурсов         |
| `describe`     | Подробности по ресурсу           |
| `logs`         | Просмотр логов                   |
| `exec`         | Выполнить команду в поде         |
| `apply -f`     | Применить манифест               |
| `delete -f`    | Удалить ресурс                   |
| `edit`         | Редактировать в реальном времени |
